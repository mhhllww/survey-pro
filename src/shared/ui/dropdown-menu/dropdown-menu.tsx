...
>(({ className, inset, children, ...props }, ref) => (
  <DropdownMenuPrimitive.SubTrigger
    ref={ref}
    className={clsx('dropdown-menu__sub-trigger', inset && 'inset', className)}
    {...props}>
    {children}
...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ref={ref}
    className={clsx('dropdown-menu__sub-content', className)}
    {...props}
  />
));
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ref={ref}
    className={clsx('dropdown-menu__item', inset && 'inset', className)}
    {...props}
  />
));
...
>(({ className, children, checked, ...props }, ref) => (
  <DropdownMenuPrimitive.CheckboxItem
    ref={ref}
    className={clsx('dropdown-menu__checkbox-item', className)}
    checked={checked}
    {...props}>
    <span className='dropdown-menu__checkmark'>
...
>(({ className, children, ...props }, ref) => (
  <DropdownMenuPrimitive.RadioItem
    ref={ref}
    className={clsx('dropdown-menu__radio-item', className)}
    {...props}>
    <span className='dropdown-menu__circle'>
      <DropdownMenuPrimitive.ItemIndicator>
        <CircleIcon />
      </DropdownMenuPrimitive.ItemIndicator>
    </span>
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Label
    ref={ref}
    className={clsx('dropdown-menu__label', inset && 'inset', className)}
    {...props}
  />
));
...
const DropdownMenuShortcut = ({
  ...
  return (
    <span className={clsx('dropdown-menu__shortcut', className)} {...props} />
  );
};
